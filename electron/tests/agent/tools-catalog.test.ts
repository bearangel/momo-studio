...
//   - ALL_BUILTIN_TOOLS 共 25 个，覆盖 v1.5+v2.3 全部工具
//   - SAFE_MINIMUM_TOOLS 是 ALL_BUILTIN_TOOLS 的真子集
//   - TOOL_CATEGORIES 覆盖 ALL_BUILTIN_TOOLS 全部 25 个，无重复
...
describe('tools/catalog 常量', () => {
  it('ALL_BUILTIN_TOOLS 共 25 个工具，覆盖 v1.5 + v2.3 apply_patch 全部', () => {
    expect(ALL_BUILTIN_TOOLS).toHaveLength(25);
  ...
  it('TOOL_CATEGORIES 覆盖 ALL_BUILTIN_TOOLS 全部 25 个，无重复', () => {
