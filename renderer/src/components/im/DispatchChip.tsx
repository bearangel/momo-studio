  ...
  return (
    <div className="mb-1">
      <button
        ...
        className="flex w-full items-center gap-1.5 rounded border border-strong bg-status-violet-tint px-2 py-1 text-left text-xs cursor-pointer transition-colors"
      >
